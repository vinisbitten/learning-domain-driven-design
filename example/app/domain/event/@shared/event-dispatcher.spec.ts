...
import SendEmailWhenCustomerIsCreated1Handler from "../customer/handler/send-email-when-customer-is-created-1.handler";
import SendEmailWhenCustomerIsCreated2Handler from "../customer/handler/send-email-when-customer-is-created-2.handler";
